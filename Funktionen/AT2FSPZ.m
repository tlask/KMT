function [best,Abbruchbed,bestOrder,AnzVergIns,AnzVergBest,AnzVerb,AnzNach] = AT2FSPZ(StartZ,StartOrder,A,BZ,Abbruchbed1,Abbruchbed2,Abbruchbed3,Ab_zeit,Ab_prozent_A2,Ab_prozent_A3,Ab_verg)
% 
% [best,Abbruchbed,bestOrder,AnzVergIns,AnzVergBest,AnzVerb,AnzNach] = <strong>AT2FSPZ</strong>(StartZ,StartOrder,A,BZ,Abbruchbed1,Abbruchbed2,Abbruchbed3,Ab_zeit,Ab_prozent_A2,Ab_prozent_A3,Ab_verg)
%
...
%   Stellplatzzeiten der Aufträge angewendet.
...
while t1 <= (m-1)
    ...
    while t2 <= m
        ...
        test = SPZ(A,testOrder,BZ); % neuen Zielfunktionswert berechnen
