function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = D2BASP(StartZ,StartOrder,A)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>D2BASP</strong>(StartZ,StartOrder,A)
%
