function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = D2BFF(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>D2BFF</strong>(StartZ,StartOrder,A,BZ)
%
