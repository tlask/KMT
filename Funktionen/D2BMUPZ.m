function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = D2BMUPZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>D2BMUPZ</strong>(StartZ,StartOrder,A,BZ)
%
