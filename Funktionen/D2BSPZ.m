function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = D2BSPZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>D2BSPZ</strong>(StartZ,StartOrder,A,BZ)
%
