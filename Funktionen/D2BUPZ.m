function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = D2BUPZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>D2BUPZ</strong>(StartZ,StartOrder,A,BZ)
%
