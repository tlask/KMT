function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = D2FASP(StartZ,StartOrder,A)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>D2FASP</strong>(StartZ,StartOrder,A)
%
