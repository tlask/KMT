function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = D2FFF(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>D2FFF</strong>(StartZ,StartOrder,A,BZ)
%
