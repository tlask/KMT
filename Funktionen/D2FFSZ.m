function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = D2FFSZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>D2FFSZ</strong>(StartZ,StartOrder,A,BZ)
%
