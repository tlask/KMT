function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = D2FMUPZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>D2FMUPZ</strong>(StartZ,StartOrder,A,BZ)
%
