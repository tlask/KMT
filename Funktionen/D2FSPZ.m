function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = D2FSPZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>D2FSPZ</strong>(StartZ,StartOrder,A,BZ)
%
