function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = D2FUPZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>D2FUPZ</strong>(StartZ,StartOrder,A,BZ)
%
