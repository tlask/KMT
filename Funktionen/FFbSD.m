function [HolArtOrder,AufKB,A,C,Auftrag_fertig] = FFbSD(A,HZ,KZ,SP,ArtOrder,AufOrder,AufKB,HolArtOrder,C,Auftrag_fertig,Artikel_neu_berechnen)
%
% [Z,HolArtOrder] = <strong>FFbS</strong> (A,HZ,KZ,SP,ArtOrder,AufOrder,AufKB,HolArtOrder,C,Auftrag_fertig,p,Artikel_neu_berechnen)
%
