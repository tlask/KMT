function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = T2BASP(StartZ,StartOrder,A)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>T2BASP</strong>(StartZ,StartOrder,A)
%
