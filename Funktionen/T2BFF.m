function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = T2BFF(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>T2BFF</strong>(StartZ,StartOrder,A,BZ)
%
