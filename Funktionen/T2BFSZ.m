function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = T2BFSZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>T2BFSZ</strong>(StartZ,StartOrder,A,BZ)
%
