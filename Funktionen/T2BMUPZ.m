function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = T2BMUPZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>T2BMUPZ</strong>(StartZ,StartOrder,A,BZ)
%
