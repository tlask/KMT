function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = T2BSPZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>T2BSPZ</strong>(StartZ,StartOrder,A,BZ)
%
