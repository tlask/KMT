function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = T2FASP(StartZ,StartOrder,A)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>T2FASP</strong>(StartZ,StartOrder,A)
%
