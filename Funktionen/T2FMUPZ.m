function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = T2FMUPZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>T2FMUPZ</strong>(StartZ,StartOrder,A,BZ)
%
