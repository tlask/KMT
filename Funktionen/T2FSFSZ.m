function [best,bestOrder,bestAufOrder,AnzVerg,AnzVerb,AnzNach] = T2FSFSZ(StartZ,StartOrder,StartAufOrder,A,BZ,HZ,KZ)
% 
% [best,bestOrder,bestAufOrder,AnzVerg,AnzVerb,AnzNach] = <strong>T2FSFSZ</strong>(StartZ,StartOrder,StartAufOrder,A,BZ,HZ,KZ)
%
