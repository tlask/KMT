function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = V1BFF(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>V1BFF</strong>(StartZ,StartOrder,A,BZ)
%
