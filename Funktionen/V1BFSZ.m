function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = V1BFSZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>V1BFSZ</strong>(StartZ,StartOrder,A,BZ)
%
