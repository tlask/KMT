function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = V1BMUPZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>V1BMUPZ</strong>(StartZ,StartOrder,A,BZ)
%
