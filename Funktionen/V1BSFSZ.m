function [best,bestOrder,bestAufOrder,AnzVerg,AnzVerb,AnzNach] = V1BSFSZ(StartZ,StartOrder,StartAufOrder,A,BZ,HZ,KZ)
% 
% [best,bestOrder,bestAufOrder,AnzVerg,AnzVerb,AnzNach] = <strong>V1BSFSZ</strong>(StartZ,StartOrder,StartAufOrder,A,BZ,HZ,KZ)
%
