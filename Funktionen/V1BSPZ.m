function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = V1BSPZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>V1BSPZ</strong>(StartZ,StartOrder,A,BZ)
%
