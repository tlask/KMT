function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = V1BUPZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>V1BUPZ</strong>(StartZ,StartOrder,A,BZ)
%
