function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = V1FASP(StartZ,StartOrder,A)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>V1FASP</strong>(StartZ,StartOrder,A)
%
