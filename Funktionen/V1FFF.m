function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = V1FFF(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>V1FFF</strong>(StartZ,StartOrder,A,BZ)
%
