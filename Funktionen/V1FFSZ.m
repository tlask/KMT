function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = V1FFSZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>V1FFSZ</strong>(StartZ,StartOrder,A,BZ)
%
