function [best,bestOrder,bestAufOrder,AnzVerg,AnzVerb,AnzNach] = V1FSFSZ(StartZ,StartOrder,StartAufOrder,A,BZ,HZ,KZ)
% 
% [best,bestOrder,bestAufOrder,AnzVerg,AnzVerb,AnzNach] = <strong>V1FSFSZ</strong>(StartZ,StartOrder,StartAufOrder,A,BZ,HZ,KZ)
%
