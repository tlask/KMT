function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = V1FSPZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>V1FSPZ</strong>(StartZ,StartOrder,A,BZ)
%
