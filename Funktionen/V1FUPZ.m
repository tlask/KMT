function [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = V1FUPZ(StartZ,StartOrder,A,BZ)
% 
% [best,bestOrder,AnzVerg,AnzVerb,AnzNach] = <strong>V1FUPZ</strong>(StartZ,StartOrder,A,BZ)
%
