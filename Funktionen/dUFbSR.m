function [Z,HolArtOrder,e] = dUFbSR(A,HZ,KZ,SP,DL,ArtOrder,AufOrder)
%
% [Z,HolArtOrder,e] = <strong>dUFbSR</strong>(A,HZ,KZ,SP,ArtOrder,AufOrder)
%
...
Z = 0; % durchschnittliche Überschreitung der Deadlines
for i = 1:n 
