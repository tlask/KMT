function [Z,HolArtOrder,e] = gUFbSR(A,HZ,KZ,SP,DL,ArtOrder,AufOrder, Gewichtung)
%
% [Z,HolArtOrder,e] = <strong>gUFbSR</strong>(A,HZ,KZ,SP,ArtOrder,AufOrder)
%
...
%   Anzahl der Stellplätze begrenzt ist und ein rollierendes  
%   Wiederholprinzip für die Artikel verwendet wird.
%
% Parameter:
